    ...
    return (
        ...
        <Grid container centered stackable columns = {3}>
          ...
          <Grid.Column textAlign='center'>
            ...
            <Header as ='h3' inverted> This adress book enables any number of users to register and save thier business contacts. You can only see the contracts you have created.</Header>
          </Grid.Column>
          <Grid.Column textAlign='center'>
